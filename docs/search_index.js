...

{
    ...
    "category": "Function",
    "text": "prettypoly(points, action=:nothing, vertex_action=() -> circle(O, 1, :fill);\n    close=false,\n    reversepath=false)\n\nDraw the polygon defined by points, possibly closing and reversing it, using the current parameters, and then evaluate the vertex_action function at every vertex of the polygon. For example, you can mark each vertex of a polygon with a randomly colored filled circle.\n\np = star(O, 70, 7, 0.6, 0, vertices=true)\nprettypoly(p, :fill, () ->\n    begin\n        randomhue()\n        circle(O, 10, :fill)\n    end,\n    close=true)\n\n\n\n"
},
